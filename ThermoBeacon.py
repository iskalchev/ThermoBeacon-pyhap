...
class ThermoBeacon(Accessory):
    ...
    def set_identify(self, value):
        ...
        try:
            ...
            self.logger.debug('Exception ' + str(exc))
            pass
        pass
    ...
    def parseData(self, bvalue):
        self.v_button = False if bvalue[3]==0 else True
        v_bat = int.from_bytes(bvalue[10:12],byteorder='little')
        self.v_batt_level = v_bat*100/4096
        ...
        self.v_uptime = int.from_bytes(bvalue[16:20],byteorder='little')
...
class ScanDelegate(DefaultDelegate):
    ...
    def handleDiscovery(self, dev, isNewDev, isNewData):
        ...
        if isNewDev:
            ...
            device.v_batt_level = int( v_bat/4096*100 )
